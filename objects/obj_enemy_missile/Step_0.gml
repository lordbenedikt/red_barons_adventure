...
if(target_obj == undefined || !instance_exists(target_obj))
{
	...
	/// @DnDHash : 255CCA3F
	/// @DnDParent : 7A27A30E
	/// @DnDArgument : "code" "/// Find red baron if exists$(13_10)$(13_10)target_obj = undefined;$(13_10)var _smallest_distance = 10000;$(13_10)$(13_10)with(obj_red_baron) {$(13_10)	_dist = point_distance(other.x,other.y,x,y);$(13_10)	if _dist < _smallest_distance {$(13_10)		_smallest_distance = _dist;$(13_10)		other.target_obj = id;$(13_10)	}$(13_10)}"
...
if(!(target_obj == undefined))
{
	...
	if(l6542349E_0)
	{
		...
		/// @DnDHash : 3C878EDA
		/// @DnDParent : 6542349E
		/// @DnDArgument : "code" "if (alarm[0] > 0) {$(13_10)	var _dir = point_direction(x, y, target_obj.x, target_obj.y);$(13_10)	var _diff_dir = direction - _dir;$(13_10)$(13_10)	if abs(_diff_dir) > 180 {$(13_10)		var _diff_dir = -360 * sign(_diff_dir) + _diff_dir; $(13_10)	}$(13_10)$(13_10)	var steering_speed = 1;$(13_10)	var _factor = min(steering_speed, abs(_diff_dir))$(13_10)	direction -= _factor * sign(_diff_dir);$(13_10)}"
		if (alarm[0] > 0) {
